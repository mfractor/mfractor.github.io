...
The v3.10 release focuses improving our on-boarding workflow, improving the UX and discoverability of code actions plus improving tooltips for images and colors and adding better refactoring support for static resources.
