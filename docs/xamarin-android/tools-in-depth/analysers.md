...
**MFractor Version 2.07.00**
## About
This document lists all analysis routines used by MFractors Xamarin.Android resource analyser.
## Analysis Routines
*32 total routines*
 ...
 * **Fix Duplicate Attributes**: Removes any duplicate attributes for an Xml node element.
 ...
 * **Apply Required Value**: Replaces an attributes value with the required value for xml element. For example, 'xmlns:android' must always be 'http://schemas.android.com/apk/res/android'.
 ...
 * **Correct Unknown Class Reference**: Replaces an invalid class reference with one that is closely named.
 ...
 * **Fix 9-patch drawable references**: Replaces a nine patch drawable reference that includes the '.9' suffix with a reference that excludes the '.9' suffix.
 ...
 * **Fix Mispelt Resource Usages**: Replaces unresolvable resource usages with an auto-suggested value based on the resources available in the project or its references.
 ...
 * **Add Required Attributes**: Adds any missing required attributes and their default values to an xml node.
 ...
 * **Fix Value Format**: Fixes typeos for inline values such as dimensions, color or floats.
 ...
 * **Fix Keywords**: Replaces a mispelt keyword with an auto-corrected suggestion or suggests from a list of valid keywords.
 ...
 * **Fix Flags**: Replaces a mispelt flag with an auto-corrected suggestion or suggests from a list of valid keywords.
