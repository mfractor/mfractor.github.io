...
| **ILocaliseSnippet** | `Code Snippet`<br/><br/>**Arguments**:<ul><li>`namespace`: The projects namespace</li><li>`name`: The name of the new localiser interface. Defaults to `ILocalise`</li></ul> | [View Code Snippet](/code-generation/xamarin-forms/snippets/xaml-localisation-infrastructure-generation/ilocalisesnippet.txt) | The code snippet to use for the `ILocalise` interface that each platform project should implement. |
