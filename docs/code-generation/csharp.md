...
| Name | Type | Defaults To | Description |
|------|------|-------------|-------------|
| **Snippet** | `Code Snippet`<br/><br/>**Arguments**:<ul><li>`type`: The fully qualified type of the event arguments.</li><li>`name`: The name of the new method.</li></ul> | <code>public void (object sender,  e)<br/>{<br/>    throw new System.NotImplementedException();<br/>}</code> | What is the code snippet to use when creating the new event handler method declaration? |
