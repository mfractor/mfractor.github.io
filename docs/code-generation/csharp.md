...
| Name | Type | Defaults To | Description |
|------|------|-------------|-------------|
| **Snippet** | `Code Snippet`<br/><br/>**Arguments**:<ul><li>`name`: The name of the new event handler.</li><li>`type`: The fully qualified type of the event arguments.</li></ul> | <code>public event EventHandler<$type> $name$;</code> | What is the code snippet to use when creating a new event handler? |
