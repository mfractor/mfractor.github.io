...
**Configuration Id: com.mfractor.code_actions.xaml.insert_column_definition**

Inserts a column definition above or below the current column definition, adjust the column and column spans for all elements inside this grid.
