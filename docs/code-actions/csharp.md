...
![The Align Namespace To Folder Path refactoring will make a namespace match the project folder path for the file!](/img/code-actions/csharp/align-namespace.gif)
...
![Use the Simplify Qualified Type refactoring to introduce usings for a qualified type reference.](/img/code-actions/csharp/simplify-qualified-type.gif)
