...
This code analyser inspects the value provided into an `ImageSource` and validates that an image of that name exists within any Android projects that reference this shared project or PCL.
...
This code analyser inspects the value provided into an `ImageSource` and validates that an image of that name exists within any iOS projects that reference this shared project or PCL.
