...
## Detect Missing Image In Linked Android Projects

**[Premium Only](https://www.mfractor.com/buy?utm_source=docs&utm_medium=premium_only)**

This code analyser inspects the value provided into an image source and validates that an image of that name exists within any Android projects that reference this shared project or PCL.

**Available Fixes**

 * [Import Unresolved Android Image Reference](/code-actions/xaml/fix.md#import-unresolved-android-image-reference)


## Detect Missing Image In Linked iOS Projects

**[Premium Only](https://www.mfractor.com/buy?utm_source=docs&utm_medium=premium_only)**

This code analyser inspects the value provided into an image source and validates that an image of that name exists within any iOS projects that reference this shared project or PCL.

**Available Fixes**

 * [Import Unresolved iOS Image Reference](/code-actions/xaml/fix.md#import-unresolved-ios-image-reference)
